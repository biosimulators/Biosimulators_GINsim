...
source_dir = os.path.join(os.path.dirname(__file__), '..', 'biosimulators_ginsim')
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

# -- Project information -----------------------------------------------------
source_base_url = 'https://github.com/biosimulators/Biosimulators_GINsim/blob/dev/'
project = 'BioSimulators-GINsim'
...
html_theme_options = {
    ...
    'github_repo': 'Biosimulators_GINsim',
    'github_banner': True,
    'github_button': True,
    'description': 'BioSimulators-compliant interface to GINsim',
    'fixed_sidebar': True,
    ...
    'extra_nav_links': {
        ...
        'CoLoMoTo': 'http://colomoto.org/',
        'SBML-qual': 'http://sbml.org/Documents/Specifications/SBML_Level_3/Packages/qual',
    }
}
